...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Generate test stubs that replay recorded interactions}
  spec.description   = %q{Record and replay object interactions. Ideal for mocking not-http services when testing (just because, for http, VCR is probably what you want)}
